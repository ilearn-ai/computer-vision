# This code was adapted from the "pyheal" package by Olivier (olvb)
# Original source code: https://github.com/olvb/pyheal
    ...
    while band:
        ...
        for nb_y, nb_x in neighbors:
            ...
            last_dist = min(
                [
                    _solve_eikonal(
                        nb_y - 1, nb_x, nb_y, nb_x - 1, height, width, dists, flags
                    ),
                    _solve_eikonal(
                        nb_y + 1, nb_x, nb_y, nb_x + 1, height, width, dists, flags
                    ),
...
def fast_marching_method(img, mask, radius=5):
